...
public class Forca extends JFrame{
	...
	public Forca(){
		...
		//Configuracao da imagem do jogo
		lblImg = new JLabel(imagem[0]);
		lblImg.setBounds(50,100,300,500);
		add(lblImg);
		
		//Configuracao do resultado do jogo
	...
	public static void main(String args[]){
		...
		//Objeto form - Configuracao de tela
	...
	private void startGame(){
		String[] palavras = {"pato", "camaro", "lasanha", "the last of us", "mexico", "dell", "florianopolis", "moto grosso", "santander"};
		...
		while (palavraString > 0 && tentativas > 0) {
			...
			String mensagem = "";
            mensagem += "Voce tem " + tentativas + " chances de adivinhar\n";
